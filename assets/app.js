...
$("#clicked").click(function () {
  $(".container").append('<h3> 🎉 Whoo-Hoo! 🎉 </h3><h4> The Stork took off! </h4><h5>Estimated Time of Arrival:</h5><p id="arrival"> </p>    <div><img src=images/please_wait.gif alt="loading" class="loading"></div> ');
});
